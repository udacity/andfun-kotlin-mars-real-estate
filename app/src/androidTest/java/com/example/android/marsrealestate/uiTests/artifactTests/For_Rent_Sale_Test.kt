...
class For_Rent_Sale_Test {
    ...
    fun for_Rent_01_Test() {
        ...
        val appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Rent"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.content),
                                        0),
        ...
        val textView = onView(
                allOf(withId(R.id.property_type_text), withText("For Rent"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()))
        textView.check(matches(withText("For Rent")))
    }

    @Test
    fun for_Sale_01_Test() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        Thread.sleep(750)
